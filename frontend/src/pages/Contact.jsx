...
const Contact = () => {
  return <section>
    <div className="px-4 mx-auto max-w-screen-md py-5">
      ...
      <form action="#" className="space-y-8">
        ...
        <div className="sm:col-span-2">
          ...
          <textarea type="text" rows="6" id="subject " placeholder="leave a comment..." className="form_input mt-1" />
        </div>
        <button type="submit" className="btn rounded sm:w-fit mb-6"> Submit</button>
      </form>
    </div>
  </section>
}
